...
private fun MovieDetailPreview() {
    CineNowTheme {
        val movie = MovieDto(
            id = 9,
            title = "Title",
            postPath = "/movie/movie",
            overview = "Long overview Long overview Long overview Long overview " +
                    "Long overview Long overview Long overview Long overview Long overview " +
                    "Long overview Long overview Long overview "
        )
